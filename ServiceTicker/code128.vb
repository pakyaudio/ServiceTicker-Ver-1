Module code128
    Public Function GenChar39(ByVal ch As Char) As String
        Select Case ch
            Case "$"
                Return "100100100101"
            Case "%"
                Return "101001001001"
            Case "*"
                Return "100101101101" ' Start/Stop
            Case "+"
                Return "100101001001"
            Case "."
                Return "110010101101"
    ...
    Function Code128(ByVal TheText As String, ByVal CodeLetter As String) As Image
        ...
        For I = 1 To Len(Binaryz)
            ...
            End If
        Next
        GraphZ.DrawString(TheText, New Font("times new roman", 8, FontStyle.Bold), New SolidBrush(Color.Black), 40, 40)
        Code128 = bmp
    End Function
