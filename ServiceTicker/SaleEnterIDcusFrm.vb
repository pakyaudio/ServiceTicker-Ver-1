...
Public Class SaleEnterIDcusFrm
    ...
    Private Sub dgSearchCustoSaveFix_MouseClick(sender As Object, e As MouseEventArgs) Handles dgSearchCustoSaveFix.MouseClick
        If Me.dgSearchCustoSaveFix.Rows.Count = 0 Then
            Exit Sub
        End If
        Me.txtSearchCusShowTel.Text = Me.dgSearchCustoSaveFix.SelectedCells(4).Value
    End Sub
    Private Sub btnSendtoSavedatafix_Click(sender As Object, e As EventArgs) Handles btnSendtoSavedatafix.Click
        If Me.dgSearchCustoSaveFix.Rows.Count = 0 Then
            Exit Sub
        End If
        SaleFrm.txtScusID.Text = Me.dgSearchCustoSaveFix.SelectedCells(0).Value
        SaleFrm.txtScusName.Text = Me.dgSearchCustoSaveFix.SelectedCells(1).Value
        SaleFrm.txtSaddress.Text = Me.dgSearchCustoSaveFix.SelectedCells(2).Value & " " & Me.dgSearchCustoSaveFix.SelectedCells(3).Value
        SaleFrm.txtScusTel.Text = Me.dgSearchCustoSaveFix.SelectedCells(4).Value
        Mainfrm.lblMainStatus.Text = "เลือกข้อมูลมาหน้าขายสินค้า"
        Me.Close()
    End Sub
