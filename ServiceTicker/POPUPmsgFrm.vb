...
Public Class POPUPmsgFrm
#Region " Variables "

    ''' <summary>
    ''' The list of currently open ToastForms.
    ''' </summary>
    Private Shared openForms As New List(Of POPUPmsgFrm)
...
#Region " Event Handlers "
    ...
    Private Sub POPUPmsgFrm_Click(sender As Object, e As EventArgs) Handles Me.Click
        If Mainfrm.WindowState = FormWindowState.Minimized Then
            Mainfrm.WindowState = FormWindowState.Maximized
            RepairStatusFrm.MdiParent = Mainfrm
            RepairStatusFrm.Show()
        ElseIf Mainfrm.WindowState = FormWindowState.Normal Then
            Mainfrm.WindowState = FormWindowState.Maximized
            RepairStatusFrm.MdiParent = Mainfrm
            RepairStatusFrm.Show()
        Else
    ...
    Private Sub ToastForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        For Each openForm As POPUPmsgFrm In POPUPmsgFrm.openForms
            openForm.Top -= Me.Height + 5
        Next

        'Add this form from the open form list.
        POPUPmsgFrm.openForms.Add(Me)
    ...
    Private Sub ToastForm_FormClosed(ByVal sender As Object, ByVal e As FormClosedEventArgs) Handles MyBase.FormClosed
        ...
        POPUPmsgFrm.openForms.Remove(Me)
    End Sub
