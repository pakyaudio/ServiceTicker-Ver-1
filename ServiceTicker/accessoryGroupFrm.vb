...
Public Class accessoryGroupFrm
    Private Sub getData()
        Try
    ...
    Private Sub dgAccessory_CellMouseDoubleClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles dgAccessory.CellMouseDoubleClick
        ...
        If Not SaveDataFixGroupFrm.txtSDFfixaccessory.Text = "" Then
            SaveDataFixGroupFrm.txtSDFfixaccessory.Text = SaveDataFixGroupFrm.txtSDFfixaccessory.Text + "," & Me.dgAccessory.SelectedCells.Item(1).Value
        Else
            SaveDataFixGroupFrm.txtSDFfixaccessory.Text = Me.dgAccessory.SelectedCells.Item(1).Value
        End If
    End Sub
End Class