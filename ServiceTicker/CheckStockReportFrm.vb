    ...
    Private Sub searchCheckStock()
        Try
            Using dt = New DataTable
                strSQL = "SELECT datetime_save,t_stock,dontcheck,checked,datetime_last FROM check_stock_id WHERE datetime_save LIKE '" & Convert.ToDateTime(DateTimePicker1.Value).ToString("yyyy-MM", CultureInfo.CreateSpecificCulture("en-EN")) & "%'"
