...
Public Class QuotationReportPrintFrm
    ...
    Private Sub ReportViewer1_Load(sender As Object, e As EventArgs) Handles ReportViewer1.Load
        ...
        strSQL = "SELECT SUM(multiply) AS ml FROM quotation WHERE quotation_id='" & PartsWithdrawalFrm.qid & "' OR quotation_id='" & CreateQuotationFrm.qid & "'"
        cmd = New MySqlCommand(strSQL, ConnectionDB)
        Call open_connection()
        Dr = cmd.ExecuteReader
        Dr.Read()
        Dim msum As Decimal
        msum = Dr.GetDecimal("ml")
