...
Public Class CQsearchCustomerFrm
    ...
    Private Sub btnSendtoSavedatafix_Click(sender As Object, e As EventArgs) Handles btnSendtoSavedatafix.Click
        If Me.dgSearchCustoSaveFix.Rows.Count = 0 Then
            Exit Sub
        End If
        CreateQuotationFrm.txtPWcusID.Text = Me.dgSearchCustoSaveFix.SelectedCells(0).Value
        CreateQuotationFrm.txtPWcusName.Text = Me.dgSearchCustoSaveFix.SelectedCells(1).Value
        ...
        CreateQuotationFrm.txtPWcusTel.Text = Me.dgSearchCustoSaveFix.SelectedCells(4).Value
        Me.Close()
    End Sub
