...
Public Class SaleCustomerStatusPrint

    Private Sub ComfixCustomerStatusPrint_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'ReportDBDataSet.salecustomerstatus' table. You can move, or remove it, as needed.
        Me.salecustomerstatusTableAdapter.Fill(Me.ReportDBDataSet.salecustomerstatus)
