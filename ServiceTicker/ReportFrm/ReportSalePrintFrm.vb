...
Public Class ReportSalePrintFrm

    Private Sub ReportSalePrintFrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'ReportDBDataSet.reportsale' table. You can move, or remove it, as needed.
        Me.reportsaleTableAdapter.Fill(Me.ReportDBDataSet.reportsale)
    ...
    Private Sub ReportViewer1_Load(sender As Object, e As EventArgs) Handles ReportViewer1.Load
        ...
        End Try
        sed = "ระหว่างวันที่  " & ReportSaleFrm.DateTimePicker1.Text & " ถึง " & ReportSaleFrm.DateTimePicker2.Text
