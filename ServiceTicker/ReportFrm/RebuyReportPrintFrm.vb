...
Public Class RebuyReportPrintFrm

    Private Sub RebuyReportPrintFrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'ReportDBDataSet.buy_pro_reword' table. You can move, or remove it, as needed.
        Me.buy_pro_rewordTableAdapter.Fill(Me.ReportDBDataSet.buy_pro_reword)
    ...
    Private Sub ReportViewer1_Load(sender As Object, e As EventArgs) Handles ReportViewer1.Load
        ...
        ReportViewer1.LocalReport.SetParameters(New ReportParameter() {c_address, c_name, buyid, ttext, toal, cbuy, em, bsta})
