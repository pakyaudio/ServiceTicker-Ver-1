...
Public Class ComfixStatusHotPrintFrm

    Private Sub ComfixStatusHotPrintFrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'ReportDBDataSet.comfixcustomerstatus_t2' table. You can move, or remove it, as needed.
        Me.comfixcustomerstatus_t2TableAdapter.Fill(Me.ReportDBDataSet.comfixcustomerstatus_t2)
