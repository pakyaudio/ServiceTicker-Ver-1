...
Public Class SaleStatusHotPrintFrm

    Private Sub ComfixStatusHotPrintFrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'ReportDBDataSet.salecustomerstatus_t2' table. You can move, or remove it, as needed.
        Me.salecustomerstatus_t2TableAdapter.Fill(Me.ReportDBDataSet.salecustomerstatus_t2)
    ...
    Private Sub ReportViewer1_Load(sender As Object, e As EventArgs) Handles ReportViewer1.Load
        ...
        If SalesCustomerStatusFrm.CheckBox1.CheckState = CheckState.Checked Then
            sed = "ระหว่างวันที่  " & SalesCustomerStatusFrm.DateTimePicker1.Text & " ถึง " & SalesCustomerStatusFrm.DateTimePicker2.Text
        ElseIf SalesCustomerStatusFrm.CheckBox1.CheckState = CheckState.Unchecked Then
            sed = ""
        End If
