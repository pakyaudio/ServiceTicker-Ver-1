...
Partial Class InvoiceReportFrm
    ...
    Private Sub InitializeComponent()
        ...
        Me.STDataSet = New ServiceTicker.STDataSet()
        Me.ReportViewer1 = New Microsoft.Reporting.WinForms.ReportViewer()
        Me.sale_barcodeTableAdapter = New ServiceTicker.STDataSetTableAdapters.sale_barcodeTableAdapter()
        ...
        Me.sale_barcodeBindingSource.DataSource = Me.STDataSet
        '
        'STDataSet
        '
        ...
        Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "ServiceTicker.InvoiceReport.rdlc"
        ...
        Me.Name = "InvoiceReportFrm"
        Me.Text = "พิมพ์ใบส่งของ(Invoice)"
    ...
    Friend WithEvents STDataSet As ServiceTicker.STDataSet
    Friend WithEvents sale_barcodeTableAdapter As ServiceTicker.STDataSetTableAdapters.sale_barcodeTableAdapter
